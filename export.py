...
def run(
        data=ROOT / 'data/sdxx.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'runs/train/exp3/weights/best.pt',  # weights path
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/sdxx.yaml', help='dataset.yaml path')
