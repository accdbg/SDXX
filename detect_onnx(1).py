...
if __name__ == "__main__":
    onnx_path = 'F:/yolov5-master/yolov5-master/runs/train/exp3/weights/best.onnx'
    model = YOLOV5(onnx_path)
    # 定义输入图片文件夹路径和输出结果文件夹路径
    path = 'F:/yolov5-master/yolov5-master/data/images/'
    output_folder = 'F:/yolov5-master/yolov5-master/text/'
    # 遍历输入文件夹中的图片
    lst2 = []
    ...
    DATA = open('F:/yolov5-master/yolov5-master/text.txt', mode="w")
    for i in lst2:
        DATA.write(str(i) + '\n')
    DATA.close()
